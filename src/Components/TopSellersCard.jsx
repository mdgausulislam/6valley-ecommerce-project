...
function TopSellersCard() {
  return (
    <div className="w-full relative bg-white rounded-md overflow-hidden cursor-pointer hover:shadow-lg">
      ...
      <div className="absolute top-14 flex items-center justify-between ml-5">
        <div className="w-20 bg-white rounded-full flex items-center justify-center p-1">
          <img
            ...
            alt=""
            className="rounded-full w-20 hover:scale-110 transition-transform duration-300"
          />
        </div>
        <div className="ml-5 pt-5">
          <h5 className="text-lg hover:text-purple-600">Wellness Fair</h5>
          <p>4.5 ratings</p>
        </div>
      </div>

      <div className="flex justify-between mt-20 px-2 py-5">
        <p className="bg-slate-200 py-1 px-4 rounded-md">
